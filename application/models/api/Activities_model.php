...
class Activities_model extends Crud_model
{
	 ...
	 {
	 	return $this->db->query("SELECT GREATEST(MAX(created_at), MAX(updated_at)) as greatest FROM `activities` LIMIT 1")->row()->greatest;
	 }
}
